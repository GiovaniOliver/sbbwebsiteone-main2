...
const NetworkingOpportunitiesComSupp: React.FC = () => {
  return (
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-6 text-gray-500">
            Connect with other community supporters, join dedicated supporter groups, and foster collaborations within the ecosystem.
          </p>
        </div>
      </div>
    </div>
...
export default NetworkingOpportunitiesComSupp;
