...
const CommunitySupportBusiOwn: React.FC = () => {
  return (
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-6 text-gray-500">
            Engage with the platform's community, seek advice, share experiences, and build meaningful connections within the ecosystem.
          </p>
        </div>
      </div>
    </div>
...
export default CommunitySupportBusiOwn;
