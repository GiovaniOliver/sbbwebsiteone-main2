-- ==============================
-- Consolidated Migration File (Part 1)
-- Core Schema: Base tables and structures
-- ==============================

-- This file consolidates the following migration files:
-- * 20240300000000_consolidated_schema.sql
-- * 20240310000000_fix_user_profiles.sql

-- ==============================
-- Base Schema (from 20240300000000_consolidated_schema.sql)
-- ==============================
...
-- ==============================
-- User Profile Fixes (from 20240310000000_fix_user_profiles.sql)
-- ==============================

-- Adding indexes to profiles table for improved performance
